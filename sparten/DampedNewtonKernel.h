...
struct DampedNewtonKernel
{
  ...
  DampedNewtonSolverConfiguration<NumericalTypes> configuration;
  SparseTensorInfo<NumericalTypes> input_info;
  KruskalTensorInfo<NumericalTypes> kruskal_info;
  Kokkos::View<DampedNewtonRowStats<element_index_t, kruskal_value_t> *> row_stats;
