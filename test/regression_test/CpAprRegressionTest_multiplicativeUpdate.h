...
/* Class declaration for CP-APR-MU testing */
...
{
	/* CP-APR Test Fixture */
	class CpAprRegressionTest_multiplicativeUpdate : public ::testing::Test
	{
		public:
		  virtual void SetUp();
		...
		protected:
		  ...
		  sparten::CpAprMultiplicativeUpdate<CpAprSparseValue, CpAprKruskalValue, CpAprElemIdx, CpAprSubIdx> *_cpApr;
	};
} // regressionTest
