...
/* Class declaration for CP-APR-PQNR testing */
...
{
	/* CP-APR Test Fixture */
	class CpAprRegressionTest_quasiNewton : public ::testing::Test
	{
		public:
		  virtual void SetUp();
		...
		protected:
		  ...
		  sparten::CpAprQuasiNewton<CpAprSparseValue, CpAprKruskalValue, CpAprElemIdx, CpAprSubIdx> *_cpApr;
	};
} // regressionTest
