...
//! CP-APR Test Fixture
class CpAprUnitTest_quasiNewton : public ::testing::Test
{
public:
  virtual void SetUp();       //!<
...
protected:
  ...
  unitTest::CpAprQuasiNewtonUnitTestOnly<CpAprSparseValue, CpAprKruskalValue, CpAprElemIdx, CpAprSubIdx> *_cpApr;  //!<
};

//! CP-APR QuasiNewton New Test Fixture
class CpAprUnitTest_quasiNewtonCpApr : public ::testing::Test
{
public:
  virtual void SetUp();       //!<
  virtual void TearDown();    //!<
...
protected:
  ...
  sparten::QuasiNewtonCpApr<sparten::PrecisionTraits<CpAprSparseValue, CpAprKruskalValue, CpAprElemIdx, CpAprSubIdx>>* _cpApr;  //!<
};
