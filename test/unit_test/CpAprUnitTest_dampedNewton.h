...
//! CP-APR Test Fixture
class CpAprUnitTest_dampedNewton : public ::testing::Test
{
public:
  virtual void SetUp();       //!<
...
protected:
  ...
  unitTest::CpAprDampedNewtonUnitTestOnly<CpAprSparseValue, CpAprKruskalValue, CpAprElemIdx, CpAprSubIdx> *_cpApr;  //!<
};
